...
export class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    // Calculate scale factor based on window size (ignoring DPR)
    ...
    // Background setup (match canvas height)
    ...
    this.background = this.add
      .tileSprite(0, 0, this.worldWidth, config.height, "background_level1")
      .setOrigin(0, 0)
      .setScale(bgScale)
      .setScrollFactor(0)
      .setDepth(-10);

...
export class CharacterSelectScene extends Phaser.Scene {
  ...
  init(data) {
    // Store which scene we should start after fighter selection
    this.nextScene = data.nextScene || "DesktopGameScene";
  }
  ...
  renderText() {
    ...
    const blackFighter = this.add
      ...
      .setInteractive()
      .setDepth(3);
    blackFighter.play("black_fighter_walk");
    ...
    const redFighter = this.add
      ...
      .setInteractive()
      .setDepth(3);
    redFighter.play("red_fighter_walk");
